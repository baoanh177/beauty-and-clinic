  ...
  return (
    <>
      <div className={clsx("flex flex-col rounded-[25px] bg-white shadow-[0px_25px_50px_5px_#F6F7FF] lg:min-w-[347px] overflow-hidden", className)}>
        ...
        <div className="mt-[56px] pb-[72px] pl-[39px] translate-x-[-.4px]">
          <h3 className="min-h-[58px] pr-[21px] text-lg font-semibold leading-[22.5px] text-[#091156] translate-y-[-.5px]">{title}</h3>
